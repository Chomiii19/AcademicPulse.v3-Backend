...
var deleteData = (0, catchAsync_1.default)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, importDeleteService_1.default.deleteAllData()];
            case 1:
                _a.sent();
                res.status(200).json({
                    status: "Success",
